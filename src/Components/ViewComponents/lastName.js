...
let lastName = (props) => {
    ...
    return(
        <div id="lastname-field">
            <input type="text" placeholder="Last Name*" className="contact-input" id="lastName" value={props.handleValue} onChange={props.handleChange} onBlur={props.handleBlur}></input>
            <br />
